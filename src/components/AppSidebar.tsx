...
import { Layout, Plus, ChevronDown, Search, Home, Users, MoreHorizontal, Pencil, Trash2, LayoutGrid } from 'lucide-react';
    ...
    <div className="flex h-screen shrink-0 group/sidebar">
      <aside className="w-[240px] bg-white flex flex-col border-r border-[#e6e9ef] transition-all">
        ...
        <div className="flex-1 overflow-y-auto px-2 py-4 space-y-1 no-scrollbar">
          ...
          <button onClick={onSelectTeam} className="flex items-center gap-2 w-full px-2 py-2 rounded text-[13px] text-[#333333] hover:bg-[#f5f6f8] transition-colors group">
